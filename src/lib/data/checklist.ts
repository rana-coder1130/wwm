...
export const checklistData: ChecklistData = {
  daily: [
    { id: 'd1', text: '每日簽到 (朝夕共賞)', sub: '活動介面' },
    { id: 'd2', text: '戰令每日任務', sub: '解好解滿' },
    { id: 'd_orders', text: '江湖號令 (6次)', sub: '點擊下方格子記錄', type: 'counter', max: 6 },
    { id: 'd_shiyimo', text: '時一墨答題', sub: '心心相印' },
    {
      id: 'd_pojun',
      text: '破軍殺將 (20:30)',
      sub: '限週三、週六',
    ...
    { id: 'd6', text: '不伏馬場賣馬', sub: '賺短陌錢 (每週限5)' },
    { id: 'd7', text: '下棋贏3次', sub: '不羨仙葉不休，賺麼玉' },
    { id: 'd8', text: '大鵝治病', sub: '每日1次，每週限5' },
    { id: 'd9', text: '消耗體力 (450點)', sub: '鍛造/製藥' },
    { id: 'd10', text: '消耗心力', sub: '副本/據點' }
  ],
  weekly: [
    {
      id: 'w_store_group',
    ...
    { id: 'w1', text: '戰令每週任務', sub: '經驗上限' },
    { id: 'w2', text: '俠境副本 (51級)', sub: '每週1次，定音石' },
    { id: 'w3', text: '不肝商店清空', sub: '請對照上方清單' },
    { id: 'w5', text: '煙花晚會 (週末)', sub: '開封豔湖 20:30，搶紅包' },
    { id: 'w6', text: '浮景行舟 (週日)', sub: '臨江驛 19:00，掛機拿獎' },
    { id: 'w7', text: '百業每週活動', sub: '駐地停留/止戈/貨運' },
    { id: 'w8', text: '不伏馬場賣馬', sub: '每週限5匹' },
    { id: 'w9', text: '八大碗兌換', sub: '隨機獲得八種碗' },
    { id: 'w10', text: '市買司倒賣', sub: '週六前賣出所有商品' }
  ]
};
